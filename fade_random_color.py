...
g = 0
b = 0
h =  float(randint(0,360))/50 # Farbwert als Farbwinkel H auf dem Farbkreis (etwa 0 für Rot, 120 für Gruen, 240 für Blau)
...
#    print h,s,v
 ...
 #       print int(rgb[2]*120)
       ...
       # time.sleep(0.1)
        if v < 0.050:
          h =  float(randint(0,100))/50 # Farbwert als Farbwinkel H auf dem Farbkreis (etwa 0 für Rot, 120 für Gruen, 240 für Blau)
	  print h
          break
        #print "UH.set_pixel({0},{1},{2},{3},{4})".format(x,y,r,g,b)
